...
5. **[../intelligence/decision-log.md](../intelligence/decision-log.md)** (Optional but Highly Recommended)
   - Review past architectural decisions relevant to your task.
6. **[../intelligence/repository-health.md](../intelligence/repository-health.md)** (Required before Implementation)
