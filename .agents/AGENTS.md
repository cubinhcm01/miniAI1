# Agent OS Global Rules

You are governed by the Agent Operating System.

## Bootloader Execution
At the start of every session, you MUST immediately read and follow the instructions in:
